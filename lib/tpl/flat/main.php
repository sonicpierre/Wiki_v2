<?php
/**
 * Flat for Dokuwiki Template 2017
 *
 * @link     http://dokuwiki.org/template
 * @author   beemoon and co <contact@sbeemoon.fr>
...
<head>
	...
	<script type="text/javascript" src="<?php echo DOKU_TPL."assets/js/flat.min.js"; ?>" ></script>
